...
const Post = () => {
  ...
  return (
    <Layout>
      <div
  className="container mx-auto p-4 min-h-screen postbg"
  style={{
...
>
        ...
        <h1 className="text-3xl text-white mb-6 text-center font-extralight">
          {editPost ? "Edit Post" : "Add Post"}   
        </h1>

        <div className="max-w-xl mx-auto p-6 rounded-lg shadow-md  card">
          <form
